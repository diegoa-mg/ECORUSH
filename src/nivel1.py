...
def run(screen: pygame.Surface, clock: pygame.time.Clock) -> str:
    ...
    flechas_portales: dict[str, list[dict]] = {
        ROOM_ENTRADA: [
            {"to": ROOM_SALA,    "pos": (920, 120),   "orient": "arriba"},
            {"to": ROOM_GARAJE,  "pos": (70, 918),   "orient": "izquierda"},
            {"to": ROOM_COCINA,  "pos": (1788, 929), "orient": "derecha"},
        ],
        ROOM_SALA: [
            {"to": ROOM_ENTRADA, "pos": (665, 979), "orient": "abajo"},
            {"to": ROOM_CUARTO1, "pos": (50, 929),   "orient": "izquierda"},
            {"to": ROOM_CUARTO2, "pos": (1794, 960), "orient": "derecha"},
        ],
        ROOM_GARAJE: [
            {"to": ROOM_ENTRADA, "pos": (1820, 880), "orient": "derecha"},
        ],
        ROOM_COCINA: [
            {"to": ROOM_ENTRADA, "pos": (81, 948),   "orient": "izquierda"},
        ],
        ROOM_CUARTO1: [
            {"to": ROOM_SALA,    "pos": (1755, 923), "orient": "derecha"},
        ],
        ROOM_CUARTO2: [
            {"to": ROOM_SALA,    "pos": (108, 954),   "orient": "izquierda"},
        ],
    }
