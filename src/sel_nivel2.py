...
def run(screen: pygame.Surface, clock: pygame.time.Clock) -> str:
    # === Música en selector de nivel 2: reanuda o inicia si no está activa ===
    try:
        resume_music()
    except Exception:
        pass
    ...
    btn_images["esp"]["titulo_niv2"] = load_img("tituloniv2.png")
    ...
    btn_images["eng"]["titulo_niv2"] = load_img("tituloniv2_eng.png")
    ...
    for lang in ["esp", "eng"]:
        btn_images[lang]["titulo_niv2"] = pygame.transform.scale(btn_images[lang]["titulo_niv2"], (1669.5, 250))
    ...
    while running:     
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if game_state == "selector":
                    if rect_sencillo.collidepoint(event.pos):
                        ...
                        pause_music()
                        # Señalar que vamos a nivel2
                        set_current_level("nivel2")
        ...
        if game_state == "selector":
            ...
            # Titulo
            screen.blit(current_img["titulo_niv2"], (125.25, 100))
