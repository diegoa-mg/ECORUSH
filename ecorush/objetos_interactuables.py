...
CONFIG_OBJETOS = {
    ...
    "cocina_nivel1.png": [_crear_objeto(
            pos=(1232, 194), size=(249,255),
            img_on="estufaprendida.png"
        ),
        _crear_objeto(
            pos=(45, 82), size=(161,357),
            img_on="refriabierto9.png"
        ),
        ],
    "garaje_nivel1.png": [],
    "cuarto1_nivel1.png": [
    ...
    "cuarto__nivel2.png": [],
    "baño_nivel2.png": [],
    "cocina_nivel2.png": [ _crear_objeto(
            pos=(1718, 62), size=(158, 382),
            img_on="refrinvv2.png"
        ),
        _crear_objeto(
            pos=(1157, 60), size=(158, 382),
            img_on="segrefrinv2.png"
        ),
        _crear_objeto(
            pos=(45, 171), size=(265, 261),
            img_on="estufanv2.png"
        ),
        _crear_objeto(
            pos=(379, 150), size=(129, 97),
            img_on="tostnv2.png"
        ),
        _crear_objeto(
            pos=(562, 132), size=(73, 115),
            img_on="licnv2.png"
        )
        ],
    # --- Nivel 3 (plano_mapa3) ---
