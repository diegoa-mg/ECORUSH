...
def run(screen: pygame.Surface, clock: pygame.time.Clock) -> str:
    ...
    plano_dir = Path(__file__).parent / "assets" / "plano_mapa2"
    ...
    room_portals: dict[str, list[dict]] = {
        ...
        ROOM_CUARTO: [
            {"rect": pygame.Rect(6, 466, 13, 331),    "to": ROOM_BANO, "spawn": (1804, 918)},
        ],
        # Cocina ↔ Sala (derecha)
        ROOM_COCINA: [
            {"rect": pygame.Rect(1890, 651, 25, 244),    "to": ROOM_BANO, "spawn": (114, 866)},
